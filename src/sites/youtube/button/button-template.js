...
<yt-button-view-model class="ytd-menu-renderer" id="ytdlpbutton-button">
  <div class="ytSegmentedLikeDislikeButtonViewModelSegmentedButtonsWrapper style-scope ytd-menu-renderer">
    <button type="button" class="yt-spec-button-shape-next yt-spec-button-shape-next--tonal yt-spec-button-shape-next--mono yt-spec-button-shape-next--size-m yt-spec-button-shape-next--enable-backdrop-filter-experiment yt-spec-button-shape-next--enable-drop-shadow-experiment yt-spec-button-shape-next--icon-leading yt-spec-button-shape-next--segmented-start" title="Start" aria-label="Start">
      ...
      <div class="yt-spec-button-shape-next__button-text-content ytdlpbutton-duration-text">
    ...
    <button type="button" class="yt-spec-button-shape-next yt-spec-button-shape-next--tonal yt-spec-button-shape-next--mono yt-spec-button-shape-next--size-m yt-spec-button-shape-next--enable-backdrop-filter-experiment yt-spec-button-shape-next--enable-drop-shadow-experiment yt-spec-button-shape-next--icon-leading ytdlpbutton-segment-mid" title="yt-dlp" aria-label="yt-dlp">
